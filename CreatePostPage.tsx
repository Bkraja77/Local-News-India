...
const CreatePostPage: React.FC<CreatePostPageProps> = ({ onBack, currentUser }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const strippedContent = content.replace(/<[^>]*>?/gm, ''); // Remove HTML tags for analysis
            ...
            // Post is created. Navigate back immediately for a fast UX.
            onBack();

            // Send notifications in the background so the user doesn't have to wait.
    ...
    return (
        <div className="flex flex-col h-full bg-transparent">
            <Header title="Create New Post" showBackButton onBack={onBack} />
            <main className="flex-grow overflow-y-auto p-5 md:p-10">
                <form onSubmit={handleSubmit} className="max-w-3xl mx-auto glass-card p-6 space-y-6">
                        ...
                        <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                            <div className="space-y-1 text-center">
                                ...
                                <div className="flex text-sm text-gray-600 justify-center">
                                    <label htmlFor="create-post-file-upload" className="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 px-2 py-1">
                    ...
                    <button type="submit" disabled={isLoading} className="w-full p-4 gradient-button text-white border-none rounded-lg text-lg font-bold cursor-pointer mt-2 disabled:opacity-50 disabled:cursor-not-allowed">
                        {isLoading ? 'Publishing...' : 'Post Article'}
                    </button>
                </form>
