...
const AdminEditUserPage: React.FC<AdminEditUserPageProps> = ({ userId, onBack, onEditPost, onViewPost }) => {
    ...
    if (loading) {
        return <div className="flex flex-col h-full"><Header title="Edit User" showBackButton onBack={onBack} /><main className="flex-grow flex items-center justify-center"><p>Loading user profile...</p></main></div>;
    }
