        ...
        <div className="flex flex-col h-full bg-transparent">
            ...
            <main className="flex-grow overflow-y-auto p-5 md:p-8 pb-20">
                <form onSubmit={handleSubmit} className="w-full glass-card p-6 md:p-8 space-y-6">
                    ...
                    <button type="submit" disabled={isLoading} className="w-full p-4 gradient-button text-white border-none rounded-lg text-lg font-bold cursor-pointer mt-2 disabled:opacity-50 shadow-md hover:shadow-lg transform transition hover:-translate-y-0.5">
